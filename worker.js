...
2e. REGLA DE ORO: los partidos SIEMPRE están abajo, en "PARTIDOS DE HOY" y en la lista de próximos. NUNCA, JAMÁS digas que "se cortó la grilla", que "no te aparecen los partidos", que "no están cargados" ni pidas que te los pasen o que "refresquen": ESTÁN AHÍ, listados con sus nombres. Ante CUALQUIER pedido de combinada o jugada, agarrá los partidos de HOY (o los primeros de la lista de próximos) y armá la boleta YA con esos nombres exactos. Si dudás, igual jugás con los que están: nunca te frenes.
